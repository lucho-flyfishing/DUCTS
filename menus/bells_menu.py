...
import resources
from ui_utils import make_scrollable   # <-- the helper above
...
def bells_menu(W, go_back, go_next):
    ...
    bells_lbl = Label(top_frame, text='Escoja el tipo de campana y presione siguiente',
    ...
    back_btn = Button(bottom_frame, text='Regresar',
                      ...
                      font=('Arial', 20, 'bold'), command=lambda: go_back(W))
    back_btn.pack(side='left', padx=10, pady=10)

    next_btn = Button(bottom_frame, text='Siguiente',
                      bg='white', fg='black', relief='raised',
                      activebackground='DodgerBlue2', activeforeground='OrangeRed2',
                      font=('Arial', 20, 'bold'), command=lambda: go_next(W))
    ...
    total_rows = 6          # was 5 — you actually use rows 0..5
    total_cols = 4
    ...
    smooth_img = resources.load_image("smooth_bell.png", size=(300, 200))
    ...
    smooth_wall_img = resources.load_image("smooth_wall_bell.png", size=(300, 200))
    ...
    conical_img = resources.load_image("conical_bell.png", size=(350, 200))
    ...
    conical_wall_img = resources.load_image("conical_wall_bell.png", size=(350, 200))
    ...
    exit_round_img = resources.load_image("round_exit_bell.png", size=(300, 200))
    ...
    exit_round_wall_img = resources.load_image("round_exit_wall_bell.png", size=(300, 200))
    ...
    exit_rect_img = resources.load_image("rectangular_exit_bell.png", size=(350, 200))
    ...
    exit_rect_wall_img = resources.load_image("rectangular_exit_wall_bell.png", size=(350, 200))
    ...
    intake_hood_img = resources.load_image("intake_hood_bell.png", size=(300, 200))
    ...
    hood_tapered_img = resources.load_image("hood_tapered_bell.png", size=(300, 200))
