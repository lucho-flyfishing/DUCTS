...
def elbows_menu(W, go_back):
    ...
    smooth_r_elbow_img_lbl.grid(row=0, column=0, padx=20, pady=20, sticky="nsew")
    ...
    round_mitered_elbow_img_lbl.grid(row=0, column=1, padx=20, pady=20, sticky="nsew")
    ...
    rectangular_mitered_elbow_img_lbl.grid(row=0, column=2, padx=20, pady=20, sticky="nsew")
    ...
    no_vanes_smooth_elbow_img_lbl.grid(row=2, column=0, padx=20, pady=20, sticky="nsew")
    ...
    no_vanes_sharp_elbow_img_lbl.grid(row=2, column=1, padx=20, pady=20, sticky="nsew")
    ...
    z_30_elbow_img_lbl.grid(row=2, column=2, padx=20, pady=20, sticky="nsew")
    ...
    round_3_4_5_pieces_elbow_img_lbl.grid(row=4, column=0, padx=20, pady=20, sticky="nsew")
