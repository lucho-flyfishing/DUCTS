...
def junctions_menu(W, go_back, go_next):
    # Clear the window
    ...
    tees_lbl = Label(top_frame, text='Escoja el tipo de unión y presione siguiente',
    ...
    total_rows = 6          # was 5 — items 9/10 live on row 5
    total_cols = 4
